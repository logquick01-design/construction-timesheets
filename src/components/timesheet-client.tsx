...
export function TimesheetClient({
  ...
  return (
    <div className="space-y-4">
      <div className="sticky top-[57px] z-30 -mx-4 border-b border-slate-200 bg-slate-100/95 px-4 py-3 backdrop-blur">
      ...
      <div className="space-y-6">
        {workersByCompany.map((group) => (
          <section key={group.name}>
            <h2 className="sticky top-[130px] z-20 mb-2 rounded-lg bg-slate-850 px-3 py-2 text-sm font-semibold text-white">
              {group.name}
